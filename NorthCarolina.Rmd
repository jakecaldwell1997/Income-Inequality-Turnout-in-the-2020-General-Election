...
vote.probit <- glm(vote2020 ~ AMEME001 + democrat + libertarian + independent + female + asian + black + native + mixed + other + pacific + undesignated + birth_age + mobilized, family = binomial(link = "probit"), data = nc_voter, na.action = na.omit)

stargazer (vote.probit, type = 'html')
```
