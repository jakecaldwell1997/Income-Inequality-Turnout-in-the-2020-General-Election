...
Previous literature suggests that the relationship between inequality and turnout is contingent on the level of analysis.  This section uses broad measures to examine this relationship at the state and county level using simple OLS models.  
